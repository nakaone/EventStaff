...
3. 将来的に
   - 参加者個々人が識別できるようにすれば「ヨーヨー50円」「射的の順番とり/4回目はNG」などを実現可能
