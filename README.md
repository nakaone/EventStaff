...
各GASの冒頭で定義する被参照局へのURLは、上図の末端から確定しておかなければならないため、各GASのデプロイは以下の順番で行う。
...
※いずれも「すぐ上の局が再デプロイしたら更新が必要」という関係。
...
システム設定 | 0000 0000 : 1000 0000 | 128 | 128 | 128 | 128 | 128
